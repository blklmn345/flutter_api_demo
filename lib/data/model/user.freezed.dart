...
abstract class $UserCopyWith<$Res> {
  ...
  $Res call(
      {int id, String name, @JsonKey(name: 'acount_ids') List<int> accountIds});
}
...
class _$_User implements _User {
  const _$_User(
      {required this.id,
      required this.name,
      @JsonKey(name: 'acount_ids') final List<int> accountIds = const []})
  ...
  @override
  String toString() {
    return 'User(id: $id, name: $name, accountIds: $accountIds)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      @JsonKey(name: 'acount_ids') final List<int> accountIds}) = _$_User;
